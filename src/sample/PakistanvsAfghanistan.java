...
public class PakistanvsAfghanistan extends Main2 {
    private Stage stage;
    private Scene scene;
    private Parent root;

    public void switchToScene2(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("../FXML_FILES/TournamentStand.fxml"));
    ...
    List<String> matchPlayedTeam12 = new ArrayList<String>();
    ...
    public void PAKvsAFG() {
        String Team1 = matchSheduleGroupB[5][0];
        String Team2 = matchSheduleGroupB[5][1];

        matchPlayedTeam12.add(Team1);
        matchPlayedTeam12.add(Team2);
        System.out.println(matchPlayedTeam12);

        Random t = new Random();

        int chooseTeam = t.nextInt(matchPlayedTeam12.size());
        String choosenTeam = matchPlayedTeam12.get(chooseTeam);
        displayTeam12.setText(choosenTeam);
    }
    ...
    public void File(ActionEvent event) {
        try {
            ...
            writer.write("Pakistan vs Afghanistan");
            writer.newLine();
